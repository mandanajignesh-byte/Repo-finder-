...
CREATE TABLE IF NOT EXISTS user_preferences (
  ...
  primary_cluster TEXT, -- NEW: Primary cluster selection (frontend, backend, mobile, etc.)
  secondary_clusters TEXT[] DEFAULT '{}', -- NEW: Secondary cluster interests
...
INSERT INTO cluster_metadata (cluster_name, display_name, description, icon, repo_count, is_active) VALUES
  ...
  ('game-dev', 'Game Development', 'Game development engines, frameworks, and tools', '🎮', 0, true),
  ('desktop', 'Desktop', 'Desktop application development frameworks and tools', '💻', 0, true)
