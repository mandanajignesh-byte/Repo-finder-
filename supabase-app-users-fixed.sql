-- ============================================
-- App Users Database Schema (Fixed for Supabase)
...
DROP POLICY IF EXISTS "Users can manage own preferences" ON app_user_preferences;
DROP POLICY IF EXISTS "Users can create own interactions" ON app_user_interactions;
DROP POLICY IF EXISTS "Users can manage own saved repos" ON app_saved_repos;
DROP POLICY IF EXISTS "Users can manage own liked repos" ON app_liked_repos;
...
DROP TRIGGER IF EXISTS trigger_update_app_user_preferences_updated_at ON app_user_preferences;
...
-- Drop trigger if exists
DROP TRIGGER IF EXISTS trigger_update_app_users_last_active ON app_user_interactions;
